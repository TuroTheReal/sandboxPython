...
| 2026-08-13 | #1 Two Sum                | arrays_hashing | ~     | non    | [ ] 08-15 | [ ] 08-20 | dict `{valeur: indice}`, un passage. Débloqué sur `enumerate` + `seen[num]=i`. Ordre check-puis-stocke correct. |
| 2026-08-13 | #49 Group Anagrams        | arrays_hashing | ~     | non    | [ ] 08-15 | [ ] 08-20 | `defaultdict(list)` + signature `tuple(sorted(mot))`. Débloqué en plusieurs passes. A creusé le concept defaultdict à fond. |
| 2026-08-14 | #347 Top K Frequent       | arrays_hashing | ~     | non    | [ ] 08-16 | [ ] 08-21 | `Counter().most_common(k)` + list comprehension pour extraire les éléments. Bugs désormais syntaxiques (import, méthode sur objet), plus algorithmiques. Time O(n log k). |
